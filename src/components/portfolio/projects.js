...
const projects = [
...

	{
		...
		description:
			"DevBook is a full stack appliation built with Node.js, Express, MongoDB, React and Redux, this is a social media for developers, developers can create a profile add experience, education, create post, and comment other user's posts."
	},
	...
	},
	{
		...
		url: 'http://veyrix.xyz',
		description:
			'This is a simple game built with vanilla JavaScript, the game objective is to hit Olaf with the hammer'
	}
];
